...
const donorFeatures = [
  {
    id: 1,
    title: "Browse Causes",
    description: "Find causes and students to support",
    icon: "heart-outline",
    color: "#E91E63"
  },
  {
  ...
  },
  {
    id: 5,
    title: "Tax Documents",
    description: "Access donation receipts and tax forms",
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <View style={styles.welcomeSection}>
              ...
              <Text style={styles.userName}>Donor</Text>
            </View>
          ...
          <View style={styles.activityCard}>
            <View style={styles.activityItem}>
              ...
              <View style={styles.activityContent}>
                <Text style={styles.activityTitle}>Donation completed</Text>
            ...
            <View style={styles.activityItem}>
              ...
              <View style={styles.activityContent}>
                <Text style={styles.activityTitle}>Student scholarship funded</Text>
            ...
            <View style={styles.activityItem}>
              ...
              <View style={styles.activityContent}>
                <Text style={styles.activityTitle}>Tax receipt generated</Text>
